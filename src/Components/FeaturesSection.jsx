  ...
  return (
    <section className='max-w-7xl mx-auto px-4 py-12'>
        ...
        <div className=' mt-12 text-center'>
            <button className='bg-blue-600 text-white cursor-pointer mt-12 px-8 py-3 rounded-full font-medium hover:bg-blue-700 transition-colors relative'>Beacome a Partner

                <div className='absolute -z-10 w-full h-full ronded-full bg-blue-600/50 blur-xl top-0 left-0'></div>
            </button>
        </div>
    </section>
  )
